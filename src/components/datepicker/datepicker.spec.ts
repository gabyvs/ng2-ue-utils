...
describe('Component: DatePicker', () => {
    ...
    it('should parse arbitary date', () => {
        const timestamp: number = 1466146800000;
    ...
    it('should filter out bad picks', () => {
        ...
        // valid in-range picks
        //dp.maxRange = 14;
        //expect(dp.isValid()).toBe(true);
    ...
    it('should generate correct calendars', () => {
        const calendar = dp.generateCalendar();
        expect(calendar.length).toEqual(dp.monthSpan);
        console.log(calendar);
        expect(calendar[0].length).toEqual(5);
